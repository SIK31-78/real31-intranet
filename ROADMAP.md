...
- **BACKLOG retours d'usage (test patron 2026-06-20)** - vide-cerveau trié depuis l'Inbox Obsidian :
  ...
  - 🐞 **Bugs / logique** (2026-06-20) : ✅ conclure exige un dossier complet (plus de conclusion d'une checklist vide) · 🔲 **décompte résolutions HS** compte les sous-résolutions de groupe (à localiser - "HS" introuvable dans le code, en attente de précision Sekou) · ✅ supervision pré-remplit la date CS depuis la copro · ✅ listes = copros actives uniquement (inactives masquées).
