...
export const ETAPES_REPRISE: ReadonlyArray<{ code: string; phase: Phase; libelle: string; role: RoleReprise }> = [
  ...
  { code: "CO3", phase: "COMMUNICATION", role: "gestionnaire", libelle: "Assurance : changement de syndic déclaré à l'assureur multirisque, relevé de sinistralité demandé, sinistres en cours repris" },
  // ---- PATRIMOINE
  ...
  { code: "CP9", phase: "COMPTABILITE", role: "referent", libelle: "Fournisseurs existants de l'annuaire ESTALE relevés avant toute création (pas de doublon)" },
  ...
  { code: "CP8", phase: "COMPTABILITE", role: "referent", libelle: "Récapitulatif et mail de fin de reprise rendus au gestionnaire" },
  // ---- EXPLOITATION
