// Cycle AG - projection "etat" : LA colonne vertebrale du cockpit (decision Sekou
// 2026-06-22). Une copro est toujours dans UN seul etat clair. Logique PURE (domaine),
// deplacee telle quelle depuis domain/etat-cycle-ag.ts lors de la fusion des deux
// modeles d'etat (S1 refonte, 2026-07-21). Les regles metier n'ont PAS change.
//
...
import { agDueDeadline, agTenuePourExerciceCourant } from "./parcours";
