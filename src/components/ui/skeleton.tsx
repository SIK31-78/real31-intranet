...
// Meme rayon que Card (rounded-md) : le squelette ne "saute" pas au chargement.
...
export function SkeletonListe({ lignes = 6 }: { lignes?: number }) {
  return (
    <div className="border border-line rounded-md bg-surface divide-y divide-line" aria-hidden="true">
...
export function SkeletonTable({ lignes = 6, colonnes = 4 }: { lignes?: number; colonnes?: number }) {
  return (
    <div className="border border-line rounded-md bg-surface overflow-hidden" aria-hidden="true">
