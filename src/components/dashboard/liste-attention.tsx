  ...
  return (
    <Card>
      ...
      <div>
        {visibles.map((item) => (
          <a
            key={item.id}
            href="#"
            className="flex items-center gap-3 px-4 py-[11px] border-b border-line last:border-b-0 hover:bg-surface-2 transition-colors duration-75"
          >
      ...
      <div className="px-4 py-2.5 text-[12px] text-ink-3 border-t border-line">
        {visibles.length} tâche{visibles.length > 1 ? "s" : ""} sur vos 23 copros ·{" "}
